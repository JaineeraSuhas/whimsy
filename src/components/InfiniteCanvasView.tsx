...
export default function InfiniteCanvasView({ photos, onOpenPhoto }: InfiniteCanvasViewProps) {
  ...
  return (
    <div className="relative w-full h-full overflow-hidden select-none bg-black">
      ...
      <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[60] pointer-events-none flex items-center justify-center gap-3 transition-opacity duration-[1500ms] w-max whitespace-nowrap ${showInstruction ? 'opacity-100' : 'opacity-0'}`}>
